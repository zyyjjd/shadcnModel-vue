...
<template>
  ...
  <section class="w-full h-screen overflow-hidden flex items-center justify-center" id="scroll-trigger-wrapper">
    ...
    <div className="fixed flex flex-col justify-center items-center px-4 z-10" id="Introduction">
    ...
    <SimplePerspectiveCard :cardClass="'md:w-[80rem]'" id='card'>
      ...
      <template #content>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-lg bg-purple-100 p-6 border-0 " id='project-1'>
          ...
          <div className="rounded-lg bg-purple-100 p-6 border-0 " id='project-2'>
          ...
          <div className="rounded-lg bg-purple-100 p-6 border-0 " id='project-3'>
          ...
          <div className="rounded-lg bg-purple-100 p-6 border-0 " id='project-4'>
